...
const traffic=[
    ...
    new Car(road.getLaneCenter(1),-1770,30,50,"DUMMY",2,getRandomColor()),
    ...
    new Car(road.getLaneCenter(2),-3850,30,50,"DUMMY",2,getRandomColor()),
    new Car(road.getLaneCenter(1),-3900,30,50,"DUMMY",2,getRandomColor()),
    new Car(road.getLaneCenter(0),-4040,30,50,"DUMMY",2,getRandomColor()),
];
...
function animate(time){
    ...
    bestCar=cars.find(
        ...
        let counter = document.getElementById("alive")
        counter.innerHTML = N-count;
